...
public class InputView {
    ...
    public String chooseNumber(){
        ...
        String numberOption = Console.readLine().trim();
        if (!Option.isValidOptionNumber(numberOption)){
            throw new IllegalArgumentException(ExceptionMessages.INVALID_OPTION_NUMBER_INPUT.getMessage());
        }
        return numberOption;
    }
